...
const AppointmentsPage = () => {
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const BillNo = "";
            const url = `http://197.138.207.30/Tenwek2208/Design/OPD/MobileMpesaRequest.aspx?PatientID=${patientID}&PhoneNumber=${phoneNumber}&BillNo=12${BillNo}&Amount=${amount}`;
            setPaymentUrl(url);
                                            ...
                                            <div>
                                                ...
                                                {app.cancel === 0 && (
                                                    <div className="text-xs font-semibold py-4 flex gap-2">
                                                        <a
                                                            href={`http://197.138.207.30/Tenwek2208/Design/CPOE/DoctorPrescription.aspx?App_ID= 567803/* ${app?.AppID} */`}
                                                            target="_blank"
